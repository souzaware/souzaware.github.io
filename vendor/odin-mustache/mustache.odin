...
render_in_layout_file :: proc(
	...
	// Read layout file.
	layout, _ := os.read_entire_file(layout_filename, allocator)
...
render_from_filename :: proc(
	...
	// Read template file.
	src, _ := os.read_entire_file(filename, allocator)
...
render_with_json :: proc(
	...
	// Load JSON.
	json_src, _ := os.read_entire_file(json_filename, allocator)
